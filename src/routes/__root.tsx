...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Salão de beleza no Bairro da Centro, Belo Horizonte MG. Cabelos, unhas, estética facial e corporal. Atendimento personalizado. Agende pelo WhatsApp." },
      { name: "author", content: "Salão de beleza Espaço de Beleza" },
      { name: "keywords", content: "salão de beleza Belo Horizonte, cabelos Belo Horizonte, manicure Belo Horizonte, estética Belo Horizonte, salão Bairro da Centro" },
      { property: "og:title", content: "Salão de beleza — Salão de Beleza no Centro, Belo Horizonte MG" },
      { property: "og:description", content: "Salão de beleza no Bairro da Centro, Belo Horizonte MG. Cabelos, unhas, estética facial e corporal. Atendimento personalizado. Agende pelo WhatsApp." },
    ...
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        sameAs: ["https://instagram.com/andrezjn"],
      }),
    }],
  }),
